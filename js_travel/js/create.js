window.onload = function(){
    ...
    function save_text_story() {
        ...
        story.innerHTML +=
            '<div class="block_story">'+
                '<p class="description_story">'+text+'</p>'+
                ...
                '</p>'+
                '<button id="top" class="button_4">top</button>'+
                '<button id="bottom" class="button_4">bot</button>'+
                '<button id="edit_block" class="button_4">edit</button>'+
                '<button id="delete_block" class="button_4">x</button>'+
            '</div>';
        clear();
    }
    ...
    function save_photo_story() {
        ...
        story.innerHTML +=
            '<div class="block_story">'+
                '<img src="images/'+img+'" alt="" class="image_story">'+
                '<p class="comments"><b>Коментарі: </b>'+
